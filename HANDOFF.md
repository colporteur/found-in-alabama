...
**Phase 1 (next): price bump + SKU rename.** Register handlers in `lib/enhance/ops.ts` (OpHandler = run + estimateCostPerJob), build batch-creation UI on the enhance page. No AI calls; exercises the queue end to end.
